let countDown; // The name of the setInternal that I used
...
const timeDisplay = document.querySelector(".timeDisplay"); // it is for 'Time is Up' phrase
...
function endTime(total) {
  ...
  endTimeDisplay.textContent = `End Time ${hrs < 10 ? "0" : ""}${hrs}:${
    min < 10 ? "0" : ""
  }${min}`;
}
